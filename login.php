    ...
    <body>
        <div id="login_container">
            ...
            <form action="login_action.php" method="POST">
                ...
                <input class="input_field" type="text" name="check" placeholder="Enter Username"><br>
                <input class="input_field" type="password" name="check" placeholder="Enter Password"><br>
